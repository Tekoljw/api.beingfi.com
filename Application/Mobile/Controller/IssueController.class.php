...
*/
		...
		if ($User['invit_1'] && $Issue['invit_1']) {
			...
			if ($invit_num_1) {
				...
				$rs[] = $mo->table('tw_invit')->add(array('userid' => $User['invit_1'], 'invit' => userid(), 'name' => $Issue['name'], 'type' => 3, 'num' => $num, 'mum' => $mum, 'fee' => $invit_num_1, 'addtime' => time(), 'status' => 1,'coin'=>strtoupper($Issue['invit_coin'])));
			}
/*
			// 直系下属认购额奖励
			...
			if ($invit_num_1s) {
				...
				$rs[] = $mo->table('tw_invit')->add(array('userid' => $User['invit_1'], 'invit' => userid(), 'name' => $Issue['name'], 'type' => 3, 'num' => $num, 'mum' => $mum, 'fee' => $invit_num_1s, 'addtime' => time(), 'status' => 1,'coin'=>strtoupper($Issue['invit_coin'])));
			}
*/
		}
		if ($User['invit_2'] && $Issue['invit_2']) {
			...
			if ($invit_num_2) {
				...
				$rs[] = $mo->table('tw_invit')->add(array('userid' => $User['invit_2'], 'invit' => userid(), 'name' => $Issue['name'], 'type' => 3, 'num' => $num, 'mum' => $mum, 'fee' => $invit_num_2, 'addtime' => time(), 'status' => 1,'coin'=>strtoupper($Issue['invit_coin'])));
			}
		}
		if ($User['invit_3'] && $Issue['invit_3']) {
			...
			if ($invit_num_3) {
				...
				$rs[] = $mo->table('tw_invit')->add(array('userid' => $User['invit_3'], 'invit' => userid(), 'name' => $Issue['name'], 'type' => 3, 'num' => $num, 'mum' => $mum, 'fee' => $invit_num_3, 'addtime' => time(), 'status' => 1,'coin'=>strtoupper($Issue['invit_coin'])));
			}
		}
