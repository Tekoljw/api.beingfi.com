...
",
    ...
    "企业社会信用代码" => "Enterprise social credit code",
    "营业执照" => "Business license",
    "银行开户许可证" => "Bank account opening permit",
    "法人身份证/护照正面" => "Legal person id card/passport front",
    "法人身份证/护照反面" => "Legal person id card/passport reverse side",
    "法人手持证件照" => "Legal person holds the certificate photo",
    "认证驳回原因" => "Reasons for rejection of certification",
    "填写未通过认证原因" => "Fill in the reasons for failure",
    "需通过高级认证后才能编辑！" => "Need to pass advanced certification before editing!",
    "用户还未上传相关信息，不能编辑！" => "Users have not uploaded relevant information, can not edit!",
    "必须填写用户ID！" => "User ID must be filled in!",
    "必须选择支付类型！" => "Payment type must be selected!",
    "必须填写支付参数！" => "Payment parameters must be filled in!",
    "必须填写支付商品名称！" => "Must fill in payment commodity name!",
    "通过高级实名认证的用户才能添加支付参数！" => "Only users with advanced real-name authentication can add payment parameters!",
    "请填写企业信息！" => "Please fill in the enterprise information!",
    "请上传证件照后再提交！" => "Please upload your id photo before submitting it!",
    "请填写法人信息！" => "Please fill in the legal person information!",
    "请填写企业名称" => "Please fill in the name of the enterprise",
    "请填写企业社会信用代码" => "Please fill in the enterprise social credit code",
    "请填写法人姓名" => "Please fill in the legal person's name",
    "请填写法人证件号码" => "Please fill in the legal person id number",
    "请上传银行开户许可证照片" => "Please upload the photo of bank opening permit",
    "请上传法人证件正面照片" => "Please upload the front photo of legal person id",
    "请上传法人证件反面照片" => "Please upload the photo on the back of legal person's id",
    "请上传法人手持证件照片" => "Please upload legal person holding id photo",
    "资质Kyc认证" => "Qualification Kyc certification",
    "资质认证" => "Qualification certification",
    "机构认证" => "Accredited institution",
    "需实名高级认证通过" => "Real name advanced certification is required",
    "机构认证状态" => "Institution certification status",
    "机构信息" => "Agency information",
    "支付参数管理" => "Payment parameter management",
    "支付类型" => "payment type",
    "新增支付参数" => "add parameter",
    "备案域名" => "domain",
    "支付商品名称" => "goods name",
    "签文密钥" => "signkey",
    "微信扫码" => "WeiXinScan",
