...
class TradeController extends AdminController
{
	...
	public function chatStatus($id = NULL, $type = NULL, $mobile = 'Chat')
	{
		...
		case 'forbid':
			$data = array('status' => 0);
			operation_log(UID, 1, "币币交易聊天状态设置禁止");
			break;

		case 'resume':
			$data = array('status' => 1);
			operation_log(UID, 1, "币币交易聊天状态设置开启");
			break;

		case 'repeal':
			$data = array('status' => 2, 'endtime' => time());
			operation_log(UID, 1, "币币交易聊天状态设置废除");
			break;

		case 'delete':
			$data = array('status' => -1);
			operation_log(UID, 1, "币币交易聊天状态设置删除");
			break;

		case 'del':
			operation_log(UID, 1, "币币交易聊天删除");
	...
	public function commentStatus($id = NULL, $type = NULL, $mobile = 'CoinComment')
	{
		...
		case 'forbid':
			$data = array('status' => 0);
			operation_log(UID, 1, "币币交易评论状态设置禁止");
			break;

		case 'resume':
			$data = array('status' => 1);
			operation_log(UID, 1, "币币交易评论状态设置开启");
			break;

		case 'repeal':
			$data = array('status' => 2, 'endtime' => time());
			operation_log(UID, 1, "币币交易评论状态设置废除");
			break;

		case 'delete':
			$data = array('status' => -1);
			operation_log(UID, 1, "币币交易评论状态设置删除");
			break;

		case 'del':
			operation_log(UID, 1, "币币交易评论删除");
			if (M($mobile)->where($where)->delete()) {
				$this->success('操作成功！');
			}
			else {
	...
	public function marketStatus($id = NULL, $type = NULL, $mobile = 'Market')
	{
		...
		case 'forbid':
			$data = array('status' => 0);
			operation_log(UID, 1, "币币交易配置状态设置禁止");
			break;

		case 'resume':
			$data = array('status' => 1);
			operation_log(UID, 1, "币币交易配置状态设置开启");
			break;

		case 'repeal':
			$data = array('status' => 2, 'endtime' => time());
			operation_log(UID, 1, "币币交易配置状态设置废除");
			break;

		case 'delete':
			$data = array('status' => -1);
			operation_log(UID, 1, "币币交易配置状态设置删除");
			break;

		case 'del':
			operation_log(UID, 1, "币币交易配置删除");
			if (M($mobile)->where($where)->delete()) {
				$this->success('操作成功！');
			}
			else {
