...
class MarketController extends AdminController
{
	...
	public function save()
	{
		...
		if ($_POST['id']) {
			operation_log(UID, 1, "币币交易市场配置编辑");
			...
			operation_log(UID, 1, "币币交易市场配置添加");
	...
	public function status()
	{
		...
		case 'forbid':
			$data = array('status' => 0);
			operation_log(UID, 1, "币币交易市场配置状态设置禁止");
			break;

		case 'resume':
			$data = array('status' => 1);
			operation_log(UID, 1, "币币交易市场配置状态设置开启");
			break;

		case 'delete':
			operation_log(UID, 1, "币币交易市场配置删除");
