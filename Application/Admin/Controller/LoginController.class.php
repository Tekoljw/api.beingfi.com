...
class LoginController extends \Think\Controller
{
	...
	public function index($username = NULL, $password = NULL, $verify = NULL, $ga_verify='', $urlkey = NULL)
	{
		if (IS_POST) {
			...
			if ($admin['password'] != md5($password)) {
				...
				M('Admin')->where(['username' => $username])->save(['last_login_time' => time(),'last_login_ip' => get_client_ip(1)]);
